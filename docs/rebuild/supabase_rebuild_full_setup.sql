...
revoke all on function public.current_guest_has_wall_message()
  from public, anon;
grant execute on function public.current_guest_has_wall_message()
  to authenticated;
...
revoke all on function public.cancel_my_gift_reservation(uuid) from public, anon;
grant execute on function public.cancel_my_gift_reservation(uuid) to authenticated;
...
revoke all on function public.cancel_my_gift_contribution(uuid) from public, anon;
grant execute on function public.cancel_my_gift_contribution(uuid) to authenticated;
